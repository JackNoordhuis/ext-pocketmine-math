...
if test "$PHP_POCKETMINE_MATH" != "no"; then
  ...
  PHP_NEW_EXTENSION(pocketmine_math, pocketmine_math.cpp lib/AxisAlignedBB.cpp lib/Bearing.cpp lib/Facing.cpp src/PhpFacing.cpp, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1 -std=c++11)
